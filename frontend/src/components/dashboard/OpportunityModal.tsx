...
export function OpportunityModal({ opportunityId, open, onClose, onUpdate }: OpportunityModalProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent hideCloseButton className="!w-[900px] !max-w-[95vw] !h-[750px] !max-h-[95vh] p-0 gap-0 overflow-hidden bg-white flex flex-col border-none shadow-2xl rounded-3xl">
        <VisuallyHidden>
