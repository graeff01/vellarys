      ...
      {isOpen &&
        createPortal(
          <div
            ...
            className="bg-white border border-gray-200 rounded-lg shadow-lg min-w-[160px] animate-in fade-in slide-in-from-top-2 duration-200"
          >
            ...
            {leads.map((lead) => {
              ...
              return (
                ...
                >
                  ...
                  <td className="py-3 px-4">
                    {/* CORRIGIDO: Dropdown com Portal */}
                    <StatusDropdown
                      lead={lead}
                      onStatusChange={handleStatusChange}
                      isUpdating={updatingStatus === lead.id}
                    />
                  </td>
                  <td className="py-3 px-4">
                    {loadingLead === lead.id ? (
            ...
            >
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex items-center justify-between">
                  {/* CORRIGIDO: Dropdown com Portal no mobile também */}
                  <StatusDropdown
                    lead={lead}
                    onStatusChange={handleStatusChange}
                    isUpdating={updatingStatus === lead.id}
