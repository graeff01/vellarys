    ...
    default_plans = [
        {
            ...
            "price_yearly": 8970.00,  # 20% desconto anual
            "sort_order": 1,
            "is_featured": True,
            "limits": {
            ...
            "features": {
                ...
                "reengagement_limit": 1,  # 1 campanha por semana
        ...
        },
        {
            ...
            "price_yearly": 19970.00,  # 20% desconto anual
            "sort_order": 2,
            "is_featured": False,
            "limits": {
            ...
            "features": {
                ...
                "security_export_lock_enabled": False,  # Export liberado
